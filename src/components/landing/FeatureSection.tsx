...
export function FeatureSection() {
  return (
    <section
      id="features"
      className="relative py-20 bg-gradient-to-b from-[#FFF9E6] via-white to-[#FFF0F5] overflow-hidden"
    >
          ...
          {features.map((feature, index) => (
            <ScrollReveal key={feature.title} delay={index * 0.1}>
              <motion.div
                ...
                whileTap={{ scale: 0.98 }}
                className={`relative p-6 rounded-3xl ${feature.color} border-2 border-pink-100 hover:border-[#C2185B] transition-all duration-300 shadow-lg hover:shadow-xl`}
              >
                ...
                <div className="flex justify-center mb-4">
                  <motion.div
                    ...
                    className="relative"
                  >
                    <div className="w-20 h-20 bg-[#C2185B]/10 rounded-2xl flex items-center justify-center">
                      <motion.div
                ...
                {/* Decorative Element */}
                <motion.div
                  className="absolute -top-2 -right-2 w-8 h-8 bg-[#C2185B] rounded-full flex items-center justify-center"
        ...
        <ScrollReveal delay={0.5}>
          <div className="mt-16 text-center">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-[#C2185B] text-white px-10 py-4 rounded-full font-semibold text-lg hover:bg-[#A01748] transition-colors shadow-lg shadow-[#C2185B]/30"
            >
