...
export function DearMyLoveClone() {
  ...
  useEffect(() => {
    // Simulate preloader wait time similar to dearmylove.org
  ...
  return (
    <main className="relative min-h-screen bg-gradient-to-t from-[#172a26] to-[#223e36] overflow-x-hidden font-sans">
      ...
      <AnimatePresence>
        {isLoading && (
          <motion.div
            ...
            className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-gradient-to-t from-[#172a26] to-[#223e36]"
          >
            <motion.div
            ...
            >
              <h1 className="text-white text-3xl font-serif tracking-[0.2em] flex items-center">
                DEAR <span className="font-mono text-xl mx-2 italic opacity-80">my</span> LOVE
              </h1>
              <p className="mt-4 text-xs text-white/50 tracking-widest uppercase">Loading...</p>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        <motion.div
          ...
          className="absolute -left-[160px] -top-20 opacity-20 w-[400px] h-[400px] lg:w-[600px] lg:h-[600px]"
        >
          <Image 
            src="/templates/landing page/dreamylove/www.dearmylove.org/_next/static/media/flower-white-full-1.8d648d33.webp" 
            alt="floral" 
            fill 
        ...
        <motion.div
          ...
          className="absolute -right-[160px] bottom-10 opacity-20 w-[400px] h-[400px] lg:w-[700px] lg:h-[700px]"
        >
          <Image 
            src="/templates/landing page/dreamylove/www.dearmylove.org/_next/static/media/flower-white-full-1.8d648d33.webp" 
            alt="floral" 
      ...
      <div className="flex flex-col items-center justify-center pt-32 pb-40 px-6 gap-24 relative z-10 w-full">
        ...
        >
          ...
          <motion.p variants={fadeInUp} className="max-w-80 leading-7 text-white text-base md:max-w-xl md:text-lg">
        ...
        >
          <motion.div variants={fadeInUp} className="relative h-48 w-72 md:h-72 md:w-[400px] overflow-hidden rounded-xl lg:rounded-2xl shadow-2xl shadow-[#172723]">
            {/* Hardcoded image from DearMyLove clone directory */}
            <Image 
        ...
        >
          <motion.div variants={fadeInUp} className="flex flex-col items-center gap-4">
            <h2 className="text-3xl font-bold md:text-4xl">All-in-One Solution</h2>
            <p className="max-w-xl text-gray-200 leading-relaxed text-base md:text-lg">
              Kami paham bahwa pengelolaan pernikahan bisa menjadi rumit. Sistem terintegrasi kami memungkinkan Anda mengirim undangan sekaligus mengelola RSVP dan interaksi tamu dalam satu tempat.
            </p>
          </motion.div>

          <motion.div variants={fadeInUp} className="flex flex-col items-center gap-4">
            <h2 className="text-3xl font-bold md:text-4xl">Mudah Digunakan, Dimana saja!</h2>
            <p className="max-w-xl text-gray-200 leading-relaxed text-base md:text-lg">
              Dengan platform berbasis cloud kami, akses rencana pernikahan Anda kapan saja, di mana saja, tanpa khawatir kehilangan informasi.
            </p>
          </motion.div>

          <motion.div variants={fadeInUp} className="flex flex-col items-center gap-4">
            <h2 className="text-3xl font-bold md:text-4xl">Layanan Bantuan yang Cepat Tanggap!</h2>
            <p className="max-w-xl text-gray-200 leading-relaxed text-base md:text-lg">
              Tenang saja, tim dedikasi kami siap mendampingi Anda di setiap langkah persiapan pernikahan. Kami siap membantu dengan pertanyaan atau permintaan khusus Anda.
            </p>
          </motion.div>
        </motion.section>

        {/* Section 3 - Smart Dashboard */}
        <motion.section
          variants={staggerContainer}
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="flex w-max max-w-md flex-col items-center gap-4 md:items-start text-center lg:text-left text-white">
            ...
            <p className="text-base leading-relaxed text-gray-200">
              adalah solusi lengkap manajemen pernikahan Anda. Kirim undangan, lacak undangan fisik, lacak RSVP, kelola preferensi tamu, dan atur tempat duduk dengan mudah.
            </p>
            <div className="mt-4 hidden flex-wrap items-center gap-2 self-start lg:flex">
              <span className="rounded-full bg-white px-3 py-1 text-sm font-semibold text-[#25332f]">Guest Management</span>
              <span className="rounded-full bg-white px-3 py-1 text-sm font-semibold text-[#25332f]">WA Blast</span>
              <span className="rounded-full bg-white px-3 py-1 text-sm font-semibold text-[#25332f]">Table Management</span>
            </div>
          </motion.div>
        </motion.section>

        {/* Section 4 - E-Invitation */}
        <motion.section
          variants={staggerContainer}
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="flex w-max max-w-md flex-col items-center gap-4 md:items-start text-center lg:text-left text-white">
            ...
            <div className="mt-4 hidden flex-wrap items-center gap-2 self-start lg:flex">
              <span className="rounded-full bg-white px-3 py-1 text-sm font-semibold text-[#25332f]">Secure</span>
              <span className="rounded-full bg-white px-3 py-1 text-sm font-semibold text-[#25332f]">Animated</span>
              <span className="rounded-full bg-white px-3 py-1 text-sm font-semibold text-[#25332f]">Custom</span>
            </div>
          </motion.div>
        </motion.section>

        {/* Dynamic App Catalog & Form Sections injected seamlessly */}
        <motion.div 
          variants={staggerContainer}
          initial="hidden"
          whileInView="visible"
      ...
      {/* Bottom Floating Nav from the Prompt */}
      <div className="fixed bottom-12 left-1/2 z-50 mt-4 flex -translate-x-1/2 items-center gap-3 rounded-full bg-[#ededed] md:px-4 xl:px-0 shadow-lg p-2">
        <a className="group relative flex h-10 w-10 items-center justify-center rounded-full transition-all hover:bg-gray-300" href="#katalog">
          <svg width="24" className="fill-[#172a26]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><path d="M61.8,29.4l8.9,8.9l0,0c2,1.9,2,5.1,0,7l0,0L47.5,68.4V36.6l7.2-7.2C56.6,27.4,59.9,27.4,61.8,29.4z M80,62.5V75c0,2.8-2.2,5-5,5H43.8l22.5-22.5H75C77.8,57.5,80,59.8,80,62.5z M20,68.8V25c0-2.8,2.2-5,5-5h12.5c2.8,0,5,2.2,5,5v43.8 c0,6.2-5,11.2-11.2,11.2S20,75,20,68.8z M31.2,73.8c2.8,0,5-2.2,5-5s-2.2-5-5-5s-5,2.2-5,5S28.5,73.8,31.2,73.8z"></path></svg>
        </a>
        <a className="group relative flex h-10 w-10 items-center justify-center rounded-full bg-[#172a26] transition-all hover:bg-[#223e36]" href="/login">
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="20" className="fill-white"><path fillRule="evenodd" d="M11 2a3 3 0 0 0-3 3v14a3 3 0 0 0 3 3h6a3 3 0 0 0 3-3V5a3 3 0 0 0-3-3h-6zm1.293 6.293a1 1 0 0 1 1.414 0l3 3a1 1 0 0 1 0 1.414l-3 3a1 1 0 0 1-1.414-1.414L13.586 13H5a1 1 0 1 1 0-2h8.586l-1.293-1.293a1 1 0 0 1 0-1.414z" clipRule="evenodd"></path></svg>
        </a>
      </div>
